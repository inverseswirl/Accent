    ...
    <div ref={reference} className="about-para-wrapper" id="about">
      <div className="about-para">
        ...
        <p className="text-center">
          We assist people with better communication{" "}
        </p>
        <p>
          We have been working in the area of Communication and Coaching for
          about 20 years. We aim to deliver best results for our clients.
        </p>
        <br />
        <h3 className="headings"> Why choose us?</h3>
        <ul>
          <li>
            Intensive, tailor-made sessions delivered on your terms and on your
            schedule
          </li>
        ...
        <div className="about-coaches">
          <div className="about-coach">
            <img
              ...
              src="https://images.pexels.com/photos/842567/pexels-photo-842567.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
              width={200}
              height={200}
            />
          ...
          <div className="about-coach">
            <img
              alt="person"
              className="about-coach-img"
              src="https://images.pexels.com/photos/864994/pexels-photo-864994.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
              width={200}
              height={200}
            />
        ...
        <p className="font-italic text-center">
          We are happy to connect with you over telephone or chat in person, so
