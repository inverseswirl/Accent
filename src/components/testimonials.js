...
const slideshare = [
  {
    ...
    name: "Ms.Rose",
    comment:
      "My communication has improved so much after using Accent's Platinum package. I would definitely recommend all to try their services.",
  },
  {
    src: testimonial2,
    name: "Ms.Jess",
    comment:
      "The basic package helped me improve my presentation skills.Thanks to accent's coaches for helping me out.",
  },
  {
    src: testimonial3,
    name: "Ms.Rene",
  ...
  },
  {
    ...
    name: "Mr. Ray",
    comment:
      "It has been a wonderful experience with Accent for personal development training.",
  },
];
